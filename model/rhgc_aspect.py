...
# export LD_LIBRARY_PATH=/disk3/zheng/icl/lib:$LD_LIBRARY_PATH 
...
def config():
    ...
    args.dataset_name = 'Musical_Instruments_aspect_test'
    args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_Musical_Instruments_output_aspect/filtered_Musical_Instruments_output_test.jsonl'
 ...
 #   args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_Industrial_and_Scientific_5as/filtered_Industrial_and_Scientific_5as.jsonl' # 修改为您的 JSONL 文件路径
  ...
  #  args.dataset_name = 'Musical_Instruments_aspect_Distill_8B'
  #  args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_Musical_Instruments_Distill_8b/filtered_Musical_Instruments_Distill_8B.jsonl'
 #   args.dataset_name = 'Industrial_and_Scientific_aspect'
 #   args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_Industrial_and_Scientific_output_aspect/filtered_Industrial_and_Scientific_output_aspect.jsonl' # 修改为您的 JSONL 文件路径
    args.dataset_name = 'yelp_reviews_70b_aspect'
    args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_yelp_reviews_output_aspect_llama70b/filtered_yelp_restaurant_reviews_70b.jsonl' # 修改为您的 JSONL 文件路径
 #   args.dataset_name = 'yelp_reviews_3b_aspect'
 #   args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_yelp_reviews_output_aspect_llama3b/filtered_yelp_restaurant_reviews_3b.jsonl' # 修改为您的 JSONL 文件路径
#    args.dataset_name = 'yelp_reviews_7b_aspect'
#    args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_yelp_reviews_output_aspect_qwen7b/filtered_yelp_restaurant_reviews_7B.jsonl' # 修改为您的 JSONL 文件路径
 #   args.dataset_name = 'Industrial_and_Scientific_1.5b_aspect'
 #   args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_Industrial_and_Scientific_output_aspect_qwen1.5b/filtered_Industrial_and_Scientific_1.5b.jsonl' # 修改为您的 JSONL 文件路径
 #   args.dataset_name ='Musical_Instruments_aspect_Distill_14B'
 #   args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_Musical_Instruments_dis_14B/filtered_Musical_Instruments_Distill_14B.jsonl'
 #   args.dataset_name = 'Musical_Instruments_aspect_part2'
 #   args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_Musical_Instruments_aspect_10-50/filtered_Musical_Instruments_aspect_10-50.jsonl' # 修改为您的 JSONL 文件路径
 ...
 #   args.dataset_name = 'yelp_reviews_qwen_1.5b_aspect'
 #   args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_yelp_reviews_output_aspect_qwen1.5b/filtered_yelp_restaurant_reviews_1.5B.jsonl' # 修改为您的 JSONL 文件路径
...
def train(params):
    ...
    for iter_idx in range(1, params.epoch):
        ...
        if valid_rmse < best_valid_rmse:
            ...
            logging_str += f'Test RMSE={test_rmse:.4f}, Test MSE={test_mse:.4f}'
